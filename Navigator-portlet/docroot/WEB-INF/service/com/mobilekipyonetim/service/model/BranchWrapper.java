...
public class BranchWrapper implements Branch, ModelWrapper<Branch> {
	...
	*/
	...
	@Override
	public int compareTo(com.mobilekipyonetim.service.model.Branch branch) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.mobilekipyonetim.service.model.Branch> toCacheModel() {
		return _branch.toCacheModel();
	}

	@Override
	public com.mobilekipyonetim.service.model.Branch toEscapedModel() {
		return new BranchWrapper(_branch.toEscapedModel());
	}

	@Override
	public com.mobilekipyonetim.service.model.Branch toUnescapedModel() {
