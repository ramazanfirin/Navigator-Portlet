...
public class OrderWrapper implements Order, ModelWrapper<Order> {
	...
	*/
	...
	@Override
	public int compareTo(com.mobilekipyonetim.service.model.Order order) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.mobilekipyonetim.service.model.Order> toCacheModel() {
		return _order.toCacheModel();
	}

	@Override
	public com.mobilekipyonetim.service.model.Order toEscapedModel() {
		return new OrderWrapper(_order.toEscapedModel());
	}

	@Override
	public com.mobilekipyonetim.service.model.Order toUnescapedModel() {
