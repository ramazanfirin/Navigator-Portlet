...
public class VehicleWrapper implements Vehicle, ModelWrapper<Vehicle> {
	...
	*/
	...
	@Override
	public int compareTo(com.mobilekipyonetim.service.model.Vehicle vehicle) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.mobilekipyonetim.service.model.Vehicle> toCacheModel() {
		return _vehicle.toCacheModel();
	}

	@Override
	public com.mobilekipyonetim.service.model.Vehicle toEscapedModel() {
		return new VehicleWrapper(_vehicle.toEscapedModel());
	}

	@Override
	public com.mobilekipyonetim.service.model.Vehicle toUnescapedModel() {
