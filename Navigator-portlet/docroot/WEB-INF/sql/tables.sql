...
create table mobilekipyonetim_Device (
	entityId INTEGER not null,
	entityId INTEGER not null,
	primary key (entityId, entityId)
);

create table mobilekipyonetim_Vehicle (
	entityId INTEGER not null,
	vehicleEntityId INTEGER not null,
	primary key (entityId, vehicleEntityId)
);
